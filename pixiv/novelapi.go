...
func (a *Api) NovelDetail(novel_id string) (*pixivstruct.NovelDetail, error) {
...
func (a *Api) NovelContent(novel_id string) (string, error) {
...
//func (a *Api) AppNovelContent(novel_id string) string {
...
//					" ", ""), -1)
//		content_text, err := UnicodeToZh([]byte(content[0][1]))
