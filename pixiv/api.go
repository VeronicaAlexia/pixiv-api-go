...
func (a *Api) UserIllusts(uid string, next_url string) (*pixivstruct.IllustsResponse, error) {
...
func (a *Api) UserBookmarksIllust(uid int, next_url string) (*pixivstruct.IllustsResponse, error) {
...
func (a *Api) IllustFollow(restrict string, offset int) ([]pixivstruct.Illust, error) {
...
func (a *Api) IllustDetail(id string) (*pixivstruct.Illust, error) {
...
func (a *Api) IllustComments(illustID int, next_url string) (*pixivstruct.IllustComments, error) {
...
func (a *Api) IllustCommentAdd(illustID int, comment string, parentCommentID int) (*pixivstruct.IllustCommentAddResult, error) {
...
func (a *Api) IllustRelated(illustID int, filter string, seedIllustIDs []string) (*pixivstruct.IllustsResponse, error) {
...
func (a *Api) Recommended(next_url string, requireAuth bool) (*pixivstruct.IllustRecommended, error) {
...
func (a *Api) IllustRanking(mode string) (*pixivstruct.IllustsResponse, error) {
...
func (a *Api) TrendingTagsIllust(filter string) (*pixivstruct.TrendingTagsIllust, error) {
...
func (a *Api) SearchIllust(word string, next_url string) (*pixivstruct.SearchIllustResult, error) {
...
func (a *Api) IllustBookmarkDetail(illustID int) (*pixivstruct.IllustBookmarkDetail, error) {
	params := map[string]string{"illust_id": strconv.Itoa(illustID)}
...
func (a *Api) IllustBookmarkAdd(illustID int, restrict string, tags []string) error {
...
func (a *Api) IllustBookmarkDelete(illustID int) error {
	params := map[string]string{"illust_id": strconv.Itoa(illustID)}
...
func (a *Api) UserBookmarkTagsIllust(restrict string, next_url string) (*pixivstruct.UserBookmarkTags, error) {
...
func (a *Api) UserFollowing(userID int, restrict string, offset int) (*pixivstruct.UserFollowList, error) {
	return userFollowStats("following", userID, restrict, offset)
}

// UserFollower Follower user list
func (a *Api) UserFollower(userID int, restrict string, offset int) (*pixivstruct.UserFollowList, error) {
...
func (a *Api) UserFollowAdd(userID int, restrict string) error {
	return userFollowPost("add", userID, restrict)
}

// UserFollowDelete Unfollow users
func (a *Api) UserFollowDelete(userID int, restrict string) error {
	return userFollowPost("delete", userID, restrict)
}

// UserMyPixiv Users in MyPixiv
func (a *Api) UserMyPixiv(userID int, next_url string) (*pixivstruct.UserFollowList, error) {
...
func (a *Api) UserList(userID int, next_url string) (*pixivstruct.UserList, error) {
...
func (a *Api) UgoiraMetadata(illustID int) (*pixivstruct.UgoiraMetadata, error) {
	params := map[string]string{"illust_id": strconv.Itoa(illustID)}
...
func (a *Api) ShowcaseArticle(showcaseID string) (*pixivstruct.ShowcaseArticle, error) {
